...
public class FERServiceImpl implements FERService {
	...
	public static final Logger logger = Logger.getLogger(FERServiceImpl.class);
	...
	public boolean registration(User user) {
		...
		logger.info("registration:: Input:: User: " + user);
		logger.debug("registration:: Input:: Password: " + user.getPassword());
		try {
		...
		logger.info("registration:: Output:: isRegister: " + isRegister);
	...
	public int login(String username, String password) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("login:: Input:: username: " + username);
		logger.debug("login:: Input:: Password: " + password);
		...
		try {
			...
			logger.error("login:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("login:: Output:: userId: " + userId);
	...
	public boolean addExpense(Expense expense) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("addExpense:: Input:: Expense: " + expense);
		...
		try {
			...
			logger.error("addExpense:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("addExpense:: Output:: isAddExpense: " + isAddExpense);
	...
	public boolean editExpense(Expense expense) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("editExpense:: Input:: Expense: " + expense);
		...
		try {
			...
			logger.error("editExpense:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("editExpense:: Output:: isEditExpense: " + isEditExpense);
	...
	public boolean deleteExpense(int id) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("deleteExpense:: Input:: id: " + id);
		...
		try {
			...
			logger.error("deleteExpense:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("deleteExpense:: Output:: isDeleteExpense: " + isDeleteExpense);

		return isDeleteExpense;
	}

	@Override
	public boolean resetPassword(int id, String currrentPassword, String newPassword) {

		boolean isResetPassword = false;
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("resetPassword:: Input:: id: " + id);
		logger.debug("resetPassword:: Input:: currrentPassword: " + currrentPassword);
		logger.debug("resetPassword:: Input:: newPassword: " + newPassword);
		...
		try {
			...
			logger.error("resetPassword:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("resetPassword:: Output:: isResetPassword: " + isResetPassword);
	...
	public List<Expense> getExpenseOptions(int userId) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("getExpenseOptions:: Input:: userId: " + userId);
		...
		try {
			...
			logger.error("getExpenseOptions:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("getExpenseOptions:: Output:: expenses: " + expenses);
	...
	public Expense getExpense(int expenseId) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("getExpense:: Input:: expenseId: " + expenseId);
		...
		try {
			...
			logger.error("getExpense:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("getExpense:: Output:: expense: " + expense);
	...
	public List<Expense> getExpenseReport(int userId, String expenseType, String fromDate, String toDate) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("getExpenseReport:: Input:: userId: " + userId + ", expenseType: " + expenseType + ", fromDate: "
		...
		try {
			...
			logger.error("getExpenseReport:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("getExpenseReport:: Output:: expenses: " + expenses);
	...
	public User getUser(int userId) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("getUser:: Input:: userId: " + userId);
		...
		logger.info("getUser:: Output:: user: " + user);
	...
	public boolean updateUser(User user) {
		...
		PreparedStatement preparedStatement = null;
		// 1.Register the driver
		logger.info("updateUser:: Input:: user: " + user);
		...
		try {
			...
			logger.error("updateUser:: SQLException: " + e.getMessage());
		} finally {

			// 5.Close the connection
			DBUtil.closeConnection(connection);
		}
		logger.info("updateUser:: Output:: isUpdateProfile: " + isUpdateProfile);
